        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('sub-category.update', $sub_categry->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="category_id">
                                    ...
                                    <option value="{{ $category->id }}" {{$category->id == $sub_categry->category_id ? 'selected' : ''}}> {{ $category->name }} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="{{ $sub_categry->name }}" name="name" id="horizontal-firstname-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description"
                                    id="horizontal-firstname-input1">{{ $sub_categry->description }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img src="{{ asset($sub_categry->image) }}" alt="" height="50" width="100">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" {{ $sub_categry->status == 1 ? 'checked' : '' }} type="radio" name="status" id="inlineRadio1"
                                        value="1">
                                    <label class="form-check-label" for="inlineRadio1">Published</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" {{ $sub_categry->status == 0 ? 'checked' : '' }} type="radio" name="status" id="inlineRadio2" value="0">
