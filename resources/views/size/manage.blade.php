                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('size.store') }}" method="POST">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="code" id="horizontal-email-input2">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input1" class="col-sm-2 col-form-label">Size Description</label>
                            <div class="col-sm-10">
                            ...
                            @foreach ($sizes as $size)
                                <tr>
                                    ...
                                    <td class="text-right">
                                        ...
                                        {{-- size edit --}}
                                        <a href="{{ route('size.edit', $size->id) }}" class="btn btn-success btn-sm"><i
